...
|`assembly_ID`| `VARCHAR` | The unique accession number of the genome assembly (e.g. GCA_001096525.1) |
...
|`AMR_associated_publications`| `INTEGER` | The PubMed ID of the publication associated with the data|
...
|`database` | `VARCHAR` | Database of annotation |
|`antibiotic_name` | `VARCHAR` | The name of the antibiotic tested (e.g. beta-lactams, trimethoprim-sulfamethoxazole)|
...
|`measurement_sign`| `VARCHAR` | The sign indicating the nature of the measurement (e.g. '==' for exact value, or '>', '<')|
|`measurement_units`| `VARCHAR` | The units for the measurement (e.g. mg/l)|
|`platform`| `VARCHAR` | The platform used for analysis (empty/NULL in the sample data)|
|`resistance_phenotype`| `VARCHAR` | The final result of the interpretation (e.g. susceptible, non-susceptible, resistant)|
|`species`| `VARCHAR` | The species of the organism (e.g. Streptococcus pneumoniae)|
|`antibiotic_abbreviation`| `VARCHAR` | A common abbreviation for the antibiotic (e.g. SXT)|
|`antibiotic_ontology`| `VARCHAR` | An ontology ID for the antibiotic (e.g. ARO_3004024)|
|`antibiotic_ontology` | `VARCHAR` | Link to the ontology resource for the ID |
...
|--------------------------|------------|-------------|
|`BioSample_ID`| `VARCHAR` | The unique identifier for the biological sample (e.g., SAMEA1028830) |
|`assembly_ID`| `VARCHAR` | The unique accession number of genome assembly (e.g., GCA_001096525.1) |
|`genus`| `VARCHAR` | The genus of the organism (e.g., Streptococcus) |
...
| `antibiotic_name` | `VARCHAR` | Normalised name of the antibiotic tested (e.g., beta-lactams, trimethoprim-sulfamethoxazole)|
|`antibiotic_abbreviation`| `VARCHAR` | A common abbreviation for the antibiotic (e.g. SXT)|
|`antibiotic_ontology`| `VARCHAR` | An ontology ID for the antibiotic (e.g., ARO_3004024)|
...
|--------------------------|------------|-------------|
|`BioSample_ID`| `VARCHAR` | The unique identifier for the biological sample (e.g., SAMEA1028830) |
|`assembly_ID`| `VARCHAR` | The accession number of the genome assembly (e.g., GCA_001096525.1) |
|`genus`| `VARCHAR` | The genus of the organism (e.g., Streptococcus) |
| `species`          | `VARCHAR` | Scientific name of the organism |
| `taxon_id`                 | `INTEGER`      | NCBI Taxonomy identifier of the orgainsm |
|`organism`| `VARCHAR` | The full name of the organism (e.g., Streptococcus pneumoniae) |
| `strain`                   | `VARCHAR` | Strain information|
| `phenotype`                   | `BOOLEAN` | Indicates if phenotype data is available for this BioSample and assembly |
| `genotype`                   | `BOOLEAN` | Indicates if genotype data is available for this BioSample and assembly |
